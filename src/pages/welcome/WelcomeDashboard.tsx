...
import swiftP1 from "../../assets/swiftP1-ohJhay.png";
import swiftP2 from "../../assets/swiftP2-ohJhay.png";
import swiftP3 from "../../assets/swiftP3-ohJhay.png";
  ...
  return (
    <>
      ...
      <Carousel fade className="carouselControl customAnimation">
        ...
        <Carousel.Item>
          <img src={transactionproofBanner} alt="Second slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img src={banner} alt="Third slide" />
        </Carousel.Item>
      </Carousel>
          ...
          <Card className="w-2/5 h-11/12 border shadow-card-shadow max-sm:w-11/12">
            ...
            <div className="customOffer2 flex  justify-between bg-white w-20">
              ...
              <div className="flex flex-col justify-between">
                <div></div>
                <p className="mb-0 bg-white p-1.5  text-2xl pt-1 font-medium text-active tablet:text-lg">
                  FAST
                </p>
              </div>
            </div>
